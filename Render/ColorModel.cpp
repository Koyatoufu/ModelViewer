...
CColorModel::CColorModel(const CColorModel& other)
{
}
...
bool CColorModel::Initialize(ID3D11Device* device)
{
	bool result;
...
int CColorModel::GetIndexCount()
{
	return m_indexCount;
}


bool CColorModel::InitializeBuffers(ID3D11Device* device)
{
...
void CColorModel::ShutdownBuffers()
{
